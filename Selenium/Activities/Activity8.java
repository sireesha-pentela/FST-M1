...
public class Activity8 {
	...
	public static void main(String[] args) {
		// Create a new instance to Firefox driver
     ...
     // Find the elements that can be clicked
       ...
       // builder.click(cargoLock).pause(1000).moveToElement(cargoToml).pause(5000).click(cargoToml).build().perform();
        builder.click(cargoLock).pause(2).moveToElement(cargoToml).pause(2).click(cargoToml).build().perform();
        ...
        builder.doubleClick(srcButton).pause(2).pause(2)
        .contextClick(targetButton).pause(10).build().perform();
        // and then open it
        builder.click(driver.findElement(By.xpath("//div[@id='menu']/div/ul/li[1]"))).pause(5).build().perform();
        // Print the front side text
